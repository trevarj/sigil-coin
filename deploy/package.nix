...
let
  ...
  sigilcoin = stdenv.mkDerivation {
    ...
    installCheckPhase = ''
      ...
      test -f $out/share/sigilcoin-site/assets/site.css
      test -f $out/share/sigilcoin-site/assets/sigilcoin-symbol.png
      test -f $out/share/sigilcoin-site/assets/sigilcoin-favicon.png
    '';
