    ...
    in
    {
      ...
      checks.${system} = {
        ...
        sigilcoin-runs = pkgs.runCommand "sigilcoin-runs" { } ''
          ...
          test -f ${built.sigilcoin}/share/sigilcoin-site/assets/site.css
          test -f ${built.sigilcoin}/share/sigilcoin-site/assets/plus-jakarta.woff2
          test -f ${built.sigilcoin}/share/sigilcoin-site/assets/jetbrains-mono.woff2
